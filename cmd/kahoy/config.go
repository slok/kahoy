...
func NewCmdConfig(args []string) (*CmdConfig, error) {
	...
	apply.Flag("auto-proceed", "applies changes without asking for confirmation. Useful to run Kahoy on non interactive scenarios like CI.").BoolVar(&c.Apply.AutoProceed)
